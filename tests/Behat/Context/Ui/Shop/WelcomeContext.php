...
namespace Tests\Blockonomics\BitcoinPaymentPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Blockonomics\BitcoinPaymentPlugin\Behat\Page\Shop\WelcomePageInterface;
